...
sun = Planet(0, 0, 0, 0, 1.989e30, "yellow")
earth = Planet(149.6e9, 0, 0, 30e8, 5.972e24, "blue")
saturn = Planet(227.9e9, 0, 0, 24e8, 6.42e24, "orange")
...
ln3, = plt.plot([], [], color=saturn.color, marker="o")
...
def dSdt(t, S):
    ...
    return [ vx1,
            ...
            vx3,
            vy3,
            earth.mass/r12**3 * (x2-x1) + saturn.mass/r13**3 * (x3-x1), #mass 1
            earth.mass/r12**3 * (y2-y1) + saturn.mass/r13**3 * (y3-y1),
            sun.mass/r12**3 * (x1-x2) + saturn.mass/r23**3 * (x3-x2), #mass 2
            sun.mass/r12**3 * (y1-y2) + saturn.mass/r23**3 * (y3-y2),
...
sol = solve_ivp(dSdt, (0, 2000), y0=[sun.x, sun.y, earth.x, earth.y, saturn.x, saturn.y,
                       sun.x_vel, sun.y_vel, earth.x_vel, earth.y_vel, saturn.x_vel, saturn.y_vel],
